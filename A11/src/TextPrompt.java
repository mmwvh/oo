 ...
 *         component when the Document of the text field is empty. The Show
 *         property is used to determine the visibility of the prompt.
 *
 *         The Font and foreground Color of the prompt will default to those
 *         properties of the parent text component. You are free to change the
 *         properties after class construction.
 */
